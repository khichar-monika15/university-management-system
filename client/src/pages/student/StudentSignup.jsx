...
export default function StudentSignup() {
  ...
  const [signupDetails, setSignupDetails] = useState({ fname: "", lname: "", email: "", password: "" });
  ...
  async function handleSignup(event) {
    ...
    setIsLoading(true);
    try {
      const res = await fetchResponse(studentEndpoints.registerStudent(), 1, signupDetails);
      if (!res.success) {
